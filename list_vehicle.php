                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h4 class="pull-left page-title">List Of Vehicle</h4>
                                ...
                                <div class="panel-body">
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo ucwords($row['cate_id']); ?></td>
                                                    <td><?php echo $row['v_brand']; ?></td>
                                                    <td><?php echo $row['v_name']; ?></td>
                                                    <td><?php echo $row['v_model']; ?></td>
                                                    <td><?php echo $row['v_fuel_type']; ?></td>
                                                    <td><?php echo $row['v_seat']; ?></td>
                                                    <td><?php echo $row['v_rentprice']; ?></td>
                                                    <td><?php echo $row['owner_id']; ?></td>
                                                    <td><?php echo $row['v_img']; ?></td>
                                                    <!-- <td>
                                                        <?php
                                                        $status = $row['status'];
                                                        ?>
