<div class="topbar-left">
    <div class="text-center"> <a href="index.php" class="logo"><img src="assets/images/prr.png" height="28"></a> <a href="index.php" class="logo-sm"><img src="assets/images/favicon.jpg" height="40"></a></div>
</div>
    ...
    <div class="container">
        <div class="">
            ...
            <ul class="nav navbar-nav navbar-right pull-right">
                <li class="dropdown hidden-xs"> <a href="#" data-target="#" class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" aria-expanded="true"> <i class="fa fa-bell"></i> <span class="badge badge-xs badge-danger">3</span> </a>
                ...
                <li class="dropdown"> <a href="#" class="dropdown-toggle profile waves-effect waves-light" data-toggle="dropdown" aria-expanded="true"><img src="assets/images/users/user_logo.jpg" alt="user-img" class="img-circle"> </a>
